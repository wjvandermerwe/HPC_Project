...
__host__ __device__
inline RGBColorF makeColorF(CFLOAT r = 0, CFLOAT g = 0, CFLOAT b = 0)
{
...
__host__ __device__
static inline RGBColorU8 COLOR_U8CREATE(uint8_t r, uint8_t g, uint8_t b)
{ return coloru8_create(r, g, b); }
#endif